                    ...
                    <form method="POST" action="{{ route('team.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                                <h2 class="text-base font-semibold leading-7 text-gray-100">Register Your Team</h2>
                                <p class="mt-1 text-sm leading-6 text-gray-300">Participate in tournaments by creating
                                    your team first.</p>
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="mb-4 col-span-full">
                                        <label for="logo" class="block text-gray-100 text-sm font-bold mb-2">Team
                                            Logo</label>
